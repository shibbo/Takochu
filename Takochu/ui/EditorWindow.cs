...
namespace Takochu.ui
{
    public partial class EditorWindow : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                uint no = entry.Get<uint>("ScenarioNo");
        ...
        public uint mCurrentScenario;

        private Galaxy mGalaxy;

        public void LoadScenario(uint scenarioNo)
        {
            ...
            Dictionary<string, uint> zoneMasks = new Dictionary<string, uint>();
        ...
        private void scenarioTreeView_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            {
                mCurrentScenario = Convert.ToUInt32(scenarioTreeView.SelectedNode.Tag);
